...
<tr>
<form action="CNMail" method="post">
<input type="email" name="mail" value="<%=em %>" hidden>
<%
...
<input type="text" hidden name="refid" value="<%=reid %>">
<td><center><input type="submit" class="button" value="Report">
	 </center></td></form>
<td><center><a href="complain.jsp"><input type="button" class="button" value="Back"></a></center></td>
</tr>
</table>
