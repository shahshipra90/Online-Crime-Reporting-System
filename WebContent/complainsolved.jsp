...
else
{
                    try 
					{
                        ...
                        ResultSet rs;
                        rs = psmnt.executeQuery("SELECT * from user_reg where Status='Solved'");
...
<form action="solvedcase detail.jsp" method="post">
<td style="padding-left:40px;"><input type="submit" class="button" value="View"></td>
<input type="hidden" name="ci" value="<%=refid %>"> </form>
<!-- <td><a href=""><form method="post" action="statusjsp.jsp"><input type="hidden" name="ci" value="<%=refid %>"><input type="submit" class="button" value="Solved"></form></a></td>-->
</tr> 
